...
const value1=false;
const value2=4<2;
console.log(`or:${value1 || value2 || check()}`) //or : 가벼운거 앞, 무거운거 뒤 - 속도 빠름
function check(){
    for(let i=0; i<10; i++){
        console.log("hello")
    }
...
console.log(`and:${value1 && value2 && check()}`) //and : false 앞 - 속도 빠름
console.log(!value1);
...
const hyun3=hyun1;
console.log(hyun1==hyun2); //false 객체
...
console.log(0==false);
console.log(0===false);
console.log(''==false); //다음 시간

//8. Ternary operators ?간단하게 출력할 때 사용(삼항조건연산자)
const g=10;
const h=3;
